 ...
 *
 * @author phuong ngo  *
 * This is the controller for account . It has session scope
 */
@Named
@SessionScoped
public class AccountController implements Serializable {
    ...
    public void setAccount(Account account) {
     ...
     /**
     * This attribute is to check user reType password is the same as the first typing or not 
     * @return string 
     */
   ...
   /**
     * this method is called when the user wants to edit the user
     * owns
     *
     * @param id
     * @return String
     ...
     * @param username the user name will be deleted
     */
    ...
    /**
     * This method is to compare input user information with database user information.
     ...
     * Get new password, Update it into database and send email to user email
     * @param dbAccount as user account information
     */
    public void resetPassword (Account dbAccount) {
        String newPassword = MyUtility.randomString(LENGTH_PW);
